...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<CharacterModel> characters,  int currentPage,  bool hasMore,  String? next,  bool isFromCache,  bool isFetchingMore)?  loaded,TResult Function( String? message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.characters,_that.currentPage,_that.hasMore,_that.next,_that.isFromCache,_that.isFetchingMore);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<CharacterModel> characters,  int currentPage,  bool hasMore,  String? next,  bool isFromCache,  bool isFetchingMore)  loaded,required TResult Function( String? message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Loaded():
return loaded(_that.characters,_that.currentPage,_that.hasMore,_that.next,_that.isFromCache,_that.isFetchingMore);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<CharacterModel> characters,  int currentPage,  bool hasMore,  String? next,  bool isFromCache,  bool isFetchingMore)?  loaded,TResult? Function( String? message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Loaded implements CharactersState {
  const _Loaded({required final  List<CharacterModel> characters, required this.currentPage, required this.hasMore, this.next, this.isFromCache = false, this.isFetchingMore = false}): _characters = characters;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_characters),currentPage,hasMore,next,isFromCache,isFetchingMore);

@override
String toString() {
  return 'CharactersState.loaded(characters: $characters, currentPage: $currentPage, hasMore: $hasMore, next: $next, isFromCache: $isFromCache, isFetchingMore: $isFetchingMore)';
}
...
@useResult
$Res call({
 List<CharacterModel> characters, int currentPage, bool hasMore, String? next, bool isFromCache, bool isFetchingMore
});
...
/// Create a copy of CharactersState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? characters = null,Object? currentPage = null,Object? hasMore = null,Object? next = freezed,Object? isFromCache = null,Object? isFetchingMore = null,}) {
